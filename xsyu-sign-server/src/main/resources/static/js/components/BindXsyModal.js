// 更新学校密码弹窗组件（用 CAS 密码验证当前账号，保存后启用自动续签）
Vue.component('bind-xsy-modal', {
    props: ['visible', 'isLoading', 'captchaSession', 'username'],
    data() {
        return {
            casPassword: '',
            captchaCode: ''
    ...
    methods: {
        handleSubmit() {
            ...
            this.$emit('bind-password', {
                casPsd: this.casPassword,
